      ...
      case 'agreement':
        return <div className="space-y-4">
            ...
            <div>
              ...
              <Input placeholder="Type your full name as signature" value={signature} onChange={e => setSignature(e.target.value)} className="mt-2" />
            </div>


            <Button onClick={handleSubmit} className="w-full" disabled={!file || !signature}>
              Submit Agreement
            </Button>
          </div>;
      case 'upload':
  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          {task.dueDate && <div className="flex items-center gap-2 text-sm text-muted-foreground">
